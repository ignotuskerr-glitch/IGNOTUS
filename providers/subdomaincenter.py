"""
ingotus/providers/subdomaincenter.py

Passive subdomain discovery via subdomain.center API (free, no API key required).
Source: https://api.subdomain.center/?domain={domain}
"""
import requests
...
def get_subdomains(domain: str) -> List[str]:
    """Queries subdomain.center free API for subdomains of domain."""
    subdomains: set = set()
